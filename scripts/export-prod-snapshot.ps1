...
$queries = [ordered]@{
  ...
  funcionarios = "$api/cr40f_funcionarioses?`$select=cr40f_funcionariosid,cr40f_nomecompleto,cr40f_status,cr40f_funcao,cr40f_validadedacnh,new_apelido,cr40f_nomedaempresa"
  marketing = "$api/new_marketings?`$select=new_status,new_categoria,new_datadepublicacao&`$orderby=new_datadepublicacao desc"
  despesas = "$api/cr40f_despesaoperacionals?`$select=cr40f_despesaoperacionalid,cr40f_nome,cr40f_datagasto,cr40f_valor,_cr40f_categoria_value,_cr40f_formapagamento_value,_cr40f_motorista_value,_cr40f_veiculo_value,_cr40f_reserva_value,_cr40f_cidade_value,_cr40f_manutencao_value,cr40f_estabelecimento,cr40f_observacao,cr40f_observacaointerna,cr40f_statusfinanceiro,cr40f_statusoperacional,cr40f_statusanexo,cr40f_origem,cr40f_possivelduplicidade,cr40f_protocolo,cr40f_kminformado,cr40f_litros,createdon,modifiedon&`$filter=statecode eq 0&`$orderby=cr40f_datagasto desc"
  categoriasDespesas = "$api/cr40f_categoriadespesaoperacionals?`$select=cr40f_categoriadespesaoperacionalid,cr40f_nome,cr40f_grupodre,cr40f_ordem,cr40f_ativa&`$filter=statecode eq 0 and cr40f_ativa eq true&`$orderby=cr40f_ordem asc"
  formasPagamentoDespesas = "$api/cr40f_formapagamentodespesas?`$select=cr40f_formapagamentodespesaid,cr40f_nome,cr40f_tipo,cr40f_ordem,cr40f_ativa&`$filter=statecode eq 0 and cr40f_ativa eq true&`$orderby=cr40f_ordem asc"
  anexosDespesas = "$api/cr40f_anexodespesaoperacionals?`$select=cr40f_anexodespesaoperacionalid,_cr40f_despesa_value,cr40f_nomearquivo,cr40f_urlsharepoint,cr40f_sharelink,cr40f_status,cr40f_tipo,createdon&`$filter=statecode eq 0&`$orderby=createdon desc"
